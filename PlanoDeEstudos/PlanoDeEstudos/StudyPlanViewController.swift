...
class StudyPlanViewController: UIViewController {
    ...
    @IBAction func schedule(_ sender: UIButton) {
        ...
        let sutdyPlan = StudyPlan(course: tfCourse.text!, section: tfSection.text!, date: dpDate.date, done: false, id: id)
        let content = UNMutableNotificationContent()
        content.title = "Lembrete"
        content.subtitle =  "Materia \(sutdyPlan.course)"
        content.body = "Estudar \(sutdyPlan.section)"
//        content.sound = UNMutableNotificationSound()
